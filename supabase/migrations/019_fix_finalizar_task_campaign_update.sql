-- Corrigir função finalizar_task para atualizar campanhas_disparo diretamente
...
BEGIN
    ...
    SELECT id, agendado_para, conexao_id INTO v_disparo_info
...
COMMENT ON FUNCTION finalizar_task(INTEGER) IS 'Função RPC para finalizar uma task de disparo, atualizando status da empresa, disparo e campanha diretamente na tabela campanhas_disparo.'; 