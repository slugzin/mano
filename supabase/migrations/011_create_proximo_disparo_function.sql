-- Função RPC para pegar o próximo disparo seguindo a ordem por fase e ordem
...
COMMENT ON FUNCTION proximo_disparo() IS 'Função RPC que retorna o próximo disparo agendado seguindo a ordem: fase_1 ordem_1, fase_1 ordem_2, fase_2 ordem_1, etc.'; 