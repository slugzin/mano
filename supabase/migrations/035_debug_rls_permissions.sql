-- Funções para diagnosticar problemas de RLS e permissões
...
-- Função para testar acesso direto à tabela
...
-- Função para verificar dados da tabela (sem RLS)
...
-- Função para verificar JWT e claims
